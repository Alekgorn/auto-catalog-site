  ...
  return (
    <article className="group flex flex-col border border-border bg-surface transition-colors duration-200 hover:border-foreground/40">
      ...
      <div className="flex flex-1 flex-col p-2.5 sm:p-3">
        {/* На телефоне название идёт в три строки, на широком экране — в две.
            В колонке шириной с половину телефона помещается около двадцати
            знаков, а названия у нас длинные: в двух строках целиком читался
            один товар из ста, и обрыв всегда съедал конец названия — как раз
            годы и диагональ, по которым и выбирают. Третья строка закрывает
            почти половину каталога. На десктопе карточка втрое шире, там
            третья строка осталась бы пустой и растянула бы весь ряд.
        ...
        <h3 className="font-head font-bold leading-snug tracking-tight text-foreground">
          <Link
            ...
            className="line-clamp-3 text-[0.9rem] transition-colors hover:text-primary sm:line-clamp-2"
          >
            {product.name}
          </Link>
        </h3>
