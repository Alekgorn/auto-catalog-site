    ...
    <div className="border border-border bg-background p-6">
      ...
      */}
      ...
      <div className="mt-5 space-y-4">
          ...
          */}
          {/*
            Ни одна проводка, привязанная к рамке, не подошла машине по
            годам. Показываем что есть — пустой экран человек читает как
            «ничего нет», хотя товар существует и, скорее всего, просто
            неточно размечен. Но выдавать это за проверенный подбор
            нельзя: отсюда и пометка.
          */}
          {res.unverified && (
              ...
              <div className="flex items-start gap-2.5">
                ...
                <div>
                  <div className="font-head text-sm font-bold uppercase tracking-tight text-[#B45309]">
                    Совместимость с вашим годом не подтверждена
                  </div>
                  <p className="mt-2 text-sm leading-relaxed text-muted-foreground">
                    Эти проводки подходят к выбранной рамке, но по годам мы
                    их для вашей машины не проверяли. Не заказывайте наугад:
                    пришлите фото разъёма за штатной магнитолой — ответим
                    точно, какая нужна.
                  </p>
                </div>
              </div>
